...
typedef bool (*arr_parse_cb)(size_t arr_len, size_t idx, struct json_object*, void* usr);
bool json_get_arr(struct json_object *h, const char *k, arr_parse_cb cb, void *usr);

// Retrieve a string key from a nested path, eg "foo.bar.baz" will return "baz" as a string
// Ownership retained by this module
